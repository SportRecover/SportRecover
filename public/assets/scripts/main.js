(function () {
    ...
    function setupNavbarToggle() {
        ...
        toggles.forEach(btn => {
            btn.addEventListener('click', () => {
                const barraNav = btn.closest('.barra-nav');
                if (!barraNav) return;
                barraNav.classList.toggle('abierto');
                btn.setAttribute('aria-expanded', barraNav.classList.contains('abierto') ? 'true' : 'false');
            });
        });
    }
    ...
    function setupLoginValidation(form) {
        ...
        form.addEventListener('submit', (e) => {
            ...
            window.location.href = 'inicio-app.html';
        });
    }
